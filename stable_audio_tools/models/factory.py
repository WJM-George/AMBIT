def create_model_from_config(model_config):
    ...
    if model_type == 'autoencoder':
        ...
        from .sceneplan_p11 import create_sceneplan_p11_from_config
        return create_sceneplan_p11_from_config(model_config)
    elif model_type == 'sceneplan_p11_v4':
        from .sceneplan_p11_v4 import create_sceneplan_p11_v4_from_config
        return create_sceneplan_p11_v4_from_config(model_config)
    elif model_type == 'sceneplan_p11_audio_aware_v1':
        from .sceneplan_p11_v4 import create_sceneplan_p11_audio_aware_from_config
        return create_sceneplan_p11_audio_aware_from_config(model_config)
    else:
...
def create_bottleneck_from_config(bottleneck_config):
    ...
    elif bottleneck_type == 'grouped_vae':
        from .bottleneck import GroupedVAEBottleneck
        bottleneck = GroupedVAEBottleneck(**bottleneck_config.get('config', {}))
