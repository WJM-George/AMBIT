...
def main(args):
    ...
    if args.limit_batches is not None:
        ...
        print(
            f"[pre_encode] trial mode: limit_val_batches={args.limit_batches} "
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt-path', type=str, help='Path to unwrapped autoencoder model checkpoint', required=True)
    ...
    parser.add_argument(
        ...
        help='Max validation batches per GPU rank (trial only). Omit for full encode.',
    )
