...
def prepare(root, data):
    ...
    config = {'schema': 'generation_ar_template100_training_v1', 'data': str(data), 'train_rows': 1600000,
        ...
        'initialize_checkpoint': '/mnt/sdc/ckpts/transfusion_sceneplan/generation_ar/attention_adaptation_quarter_epoch_20260905_v1/training/checkpoints/step_00002084.pt',
        'initialize_checkpoint_sha256': '9f7006171b64c061daa6cfda2bfef8621af4a19dacb6b624437d50f062b29bcb',
        'codec': '/mnt/sdb/audio_dataset/sceneplan_v2_1p124m/p11_single_turn_15s_v2/model_sceneplan_codec_v4',
...
if __name__ == '__main__':
    ...
    p.add_argument('--python', default='/mnt/sdc/stable-audio-tools-workspace/.venv/bin/python3'); args = p.parse_args()
    try: main(args)
