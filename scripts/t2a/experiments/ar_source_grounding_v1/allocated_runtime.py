...
Latest userallocation reservesGPU0–1 forRL. New jobs useexclusiveperGPU
locks; theoldfailedfullchain mustremaininactive beforelaunch.
"""
...
def selected_gpus(value=None):
    ...
    if not set(indices) <= {2,3,4,5,6,7}:
        raise ValueError("Editing uses GPU2–7; GPU0–1 are reserved forTransfusionRL")
