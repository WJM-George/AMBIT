...
echo "    --sls-root /mnt/sdb/audio_dataset/datasets/spatial_librispeech \\"
echo "    --mrsdrama-root /mnt/sdd/audio_dataset/datasets/mrsdrama/snapshot \\"
echo "    --steps 1000 --batch-size 4 --out-dir /mnt/sdc/vae_4ch_sanity_out"
